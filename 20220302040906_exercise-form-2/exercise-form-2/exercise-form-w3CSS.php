...
<div class="w3-container w3-blue">
  <h2>My Form</h2>
    ...
    <form class="w3-container w3-card-4 w3-grey"  method="post" action="management.php">
        ...
        <p>
            <label class="w3-text-white"><?php  echo  $_POST['name'] ?></label>
            <input type="password" name="<" value="">
        </p>
            <button class="w3-btn w3-Indigo" style="width: 1340px"><?php echo $forms[6]['id']?></button></p>
    </form>
